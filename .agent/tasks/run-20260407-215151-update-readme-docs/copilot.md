<!-- SHREY-JUNIOR:FILE-START .agent/tasks/run-20260407-215151-update-readme-docs/copilot.md -->
---
schema: shrey-junior/task-packet@v1
packet_type: run
title: "Copilot Run Packet"
...
primary_tool: claude
review_tool: codex
supporting_role: "inline or local edit acceleration"
native_surface: .github/copilot-instructions.md
...
<!-- SHREY-JUNIOR:FILE-END .agent/tasks/run-20260407-215151-update-readme-docs/copilot.md -->
