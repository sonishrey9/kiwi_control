...
import { buildHandoffRecord, renderHandoffBrief, renderHandoffMarkdown } from "@shrey-junior/sj-core/core/handoff.js";
import type { CompiledContext } from "@shrey-junior/sj-core/core/context.js";
import type { GitState } from "@shrey-junior/sj-core/core/git.js";
import type { PhaseRecord } from "@shrey-junior/sj-core/core/state.js";
...
test("handoff rendering preserves the previous phase summary and remaining risks", () => {
  ...
  const handoff = buildHandoffRecord({
    ...
    context,
    gitState,
    recommendedSpecialistId: "qa-specialist",
