    ...
    <div class="kc-view-shell">
      <section class="kc-view-header">
        <div>
          ...
          <h1>Machine State</h1>
          <p>Machine setup guidance and repair commands. Repo-local Kiwi state still wins. Generated by ${escapeHtml(machine.generatedBy)}.</p>
        </div>
      ...
      <section class="kc-panel kc-panel-primary" data-render-section="machine-setup-readiness">
        ...
        <div class="kc-two-column">
          ...
          <section class="kc-subpanel">
            <div class="kc-stack-list">
              ${renderNoteRow(machineHero.nextFixLabel, machineHero.nextFixCommand, machineHero.overallStatus === "stale" ? "Refresh this first, then trust the detailed setup guidance below." : "Run this next to improve machine readiness or inspect the remaining gap.")}
            </div>
          </section>
        </div>
      </section>
