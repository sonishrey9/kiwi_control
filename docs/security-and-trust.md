...
- installed desktop builds auto-attempt terminal command setup on first launch after explicit OS/admin approval where required, but desktop usage still works if that setup cannot complete
