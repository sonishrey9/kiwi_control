...
npm run release:trust -- --platform macos --json
node scripts/generate-github-release-downloads.mjs --publish-root dist/release/publish --repo owner/repo --release-tag v0.2.0-beta.9 --release-json /path/to/release.json
```
